...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col w-full bg-accent pb-80">
                <div className="grid h-auto card  mt-10 mx-5 p-6 rounded-box place-items-center">
                    ...
                    <label className="label grid grid-rows-2 ">
                        ...
                        <span className="label-text-alt">New at Kriova? <Link className='text-white' to='/register'>Please Register.</Link > </span>
                    </label>
